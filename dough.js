...
///////////////////////////////////////////////////////////
    ...
    d3.csv("population.csv", createPie);
    function createPie(error, data) {
        var filtered = data.map(function (d) {
            var obj = {};
            var pieData = [];
            Object.keys(d).map(function (key) {
                if (key == 'uspop' || key == 'immigrants') {
                    var item = {};
                    item['itemLabel'] = key;
                    item['itemValue'] = +d[key];
                    pieData.push(item);
                }
            });
            obj.data = pieData;
...
// to run each time data is generated
    function update(number) {
        ...
        data1 = dataStructure[number].data;
        ...
        function filterData(element, index, array) {
            element.name = data1[index].itemLabel;
            element.value = data1[index].itemValue;
